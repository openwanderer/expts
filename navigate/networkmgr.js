...
class NetworkMgr {
    ...
    route (curPt, pois, options = {}) {
        ...
        for(let i=0; i<sorted.length; i++) {
            ...
            curPOIsForThisBearing.push(sorted[i]);
        ...
        const poisGroupedByBearingSortedByDistance = poisGroupedByBearing.map ( forThisBearing => forThisBearing.sort((n1, n2) => n1.weight - n2.weight));
